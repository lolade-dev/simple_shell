...
This project, `simple_shell`, is a custom implementation of a simple UNIX shell as a requirement to complete the first sprint in the ALX 12-month SE program. Taking a minimalistic approach, the following functions have been implemented: `access, execve, exit, fork, free, fstat, getline, malloc, perror, signal, stat, wait, write.`
 ...
 * Clone the current repository with the command: ```git clone "https://github.com/lolade-dev/simple_shell.git"```
...
## Authors
Abu-safyan Yusuf | [@Sufyan-codes](https://github.com/Sufyan-codes)

Ololade Olanrewaju | [@lolade-dev](https://github.com/lolade-dev)
